...
<head>
    ...
    <link href="{{ asset('assetslanding/lib/lightbox/css/lightbox.min.css') }}" rel="stylesheet">
...
<body>
    ...
    <script src="{{ asset('assetslanding/lib/lightbox/js/lightbox.min.js') }}"></script>
