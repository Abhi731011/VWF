                        ...
                        <div class="col-4">
                            <div class="footer-gallery">
                                ...
                                <div class="footer-search-icon">
                                    <a href="{{ asset('assetslanding/img/gallery-footer-1.jpg') }}" data-lightbox="footerGallery-1" class="my-auto"><i class="fas fa-search-plus text-white"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="footer-gallery">
                                ...
                                <div class="footer-search-icon">
                                    <a href="{{ asset('assetslanding/img/gallery-footer-2.jpg') }}" data-lightbox="footerGallery-2" class="my-auto"><i class="fas fa-search-plus text-white"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="footer-gallery">
                                ...
                                <div class="footer-search-icon">
                                    <a href="{{ asset('assetslanding/img/gallery-footer-3.jpg') }}" data-lightbox="footerGallery-3" class="my-auto"><i class="fas fa-search-plus text-white"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="footer-gallery">
                                ...
                                <div class="footer-search-icon">
                                    <a href="{{ asset('assetslanding/img/gallery-footer-4.jpg') }}" data-lightbox="footerGallery-4" class="my-auto"><i class="fas fa-search-plus text-white"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="footer-gallery">
                                ...
                                <div class="footer-search-icon">
                                    <a href="{{ asset('assetslanding/img/gallery-footer-5.jpg') }}" data-lightbox="footerGallery-5" class="my-auto"><i class="fas fa-search-plus text-white"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="footer-gallery">
                                ...
                                <div class="footer-search-icon">
                                    <a href="{{ asset('assetslanding/img/gallery-footer-6.jpg') }}" data-lightbox="footerGallery-6" class="my-auto"><i class="fas fa-search-plus text-white"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
